...
const GradientCard = ({ title, desc, date }) => {
  return (
    <div class="relative block p-6 overflow-hidden border border-gray-100 rounded-lg bg-neutral">
      <span class="absolute inset-x-0 bottom-0 h-2  bg-gradient-to-r from-green-300 via-blue-500 to-purple-600" />

      <div class="justify-between sm:flex">
        <div>
          <h5 class="text-xl font-bold text-gray-200">
            {title}
          </h5>
