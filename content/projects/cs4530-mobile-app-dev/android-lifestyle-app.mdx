...
export const vars = { title: "Lifestyle App",
            summary: "An Android app for tracking health and planning outdoor activities.",
            descriptions: [
              { heading: 'Tools & Languages', body: 'Kotlin, Java, SQLite, Android Studio' },
              { heading: 'Project Timeline', body: 'January 2022 - May 2022' },
              { heading: 'Project Type', body: 'Group Coursework | Team of 4' },
              { heading: 'My Roles', body: 'Code Architecture, UI Implementation, Unit Testing' },
            ],
}
