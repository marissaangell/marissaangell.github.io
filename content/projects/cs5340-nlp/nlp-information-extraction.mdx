...
export const vars = { title: "NLP Information Extraction",
            summary: "Using natural language processing to extract key information from articles.",
            descriptions: [
              { heading: 'Tools & Languages', body: 'Python, spaCy, Docker' },
              { heading: 'Project Timeline', body: 'October 2021 - December 2021' },
              { heading: 'Project Type', body: 'Group Coursework (Team of 2)' },
              { heading: 'My Roles', body: 'Extraction Rules, Contanerization, Testing' },
            ],
}

import nlp1 from './nlp1.jpg'
import nlp2 from './nlp2.jpg'
import nlp3 from './nlp3.jpg'
import nlp4 from './nlp4.jpg'
import nlp5 from './nlp5.jpg'
import nlp6 from './nlp6.jpg'
